// api/cron.js
import db from './db.js'; // убедись, что путь к db.js правильный
import { SendRender } from './get.js'; // предполагается, что SendRender экспортируется как именованный экспорт
